...
class Guestbook(webapp2.RequestHandler):
  def post(self):
    ...
    greeting.put()
    self.redirect('/Testing/Donglin/sign?' + urllib.urlencode({'guestbook_name': guestbook_name}))


app = webapp2.WSGIApplication([('/Testing/Donglin', MainPage),
                               ('/Testing/Donglin/sign', Guestbook)],
                              debug=True)